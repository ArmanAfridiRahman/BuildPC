            ...
            <form action="{{route('category.save')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="left">
                    <div class="category-name">
                        <input type="text" value="{{$category->category_name}}" class="form-control" placeholder="category name" name="category_name">
                    </div>
                    <div class="category-picture">
                        ...
                        <img class="picture" src="{{asset($category->category_picture)}}" alt="">
                    </div>
                </div>
                <div class="category-description">
                    <textarea type="text" class="description" placeholder="Add a description" name="category_description">{{$category->category_description}}</textarea>
                </div>
