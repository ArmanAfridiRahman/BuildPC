            ...
            <form action="{{route('brand.save')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="left">
                    <div class="brand-name">
                        <input type="text" value="{{$brand->brand_name}}" class="form-control" placeholder="brand name" name="brand_name">
                    </div>
                    <div class="brand-picture">
                        ...
                        <img class="picture" src="{{asset($brand->brand_picture)}}" alt="">
                    </div>
                </div>
                <div class="brand-description">
                    <textarea type="text" class="description" placeholder="Add a description" name="brand_description">{{$brand->brand_description}}</textarea>
                </div>
